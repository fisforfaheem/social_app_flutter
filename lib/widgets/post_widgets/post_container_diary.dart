...
class PostContainerDiary extends StatelessWidget {
  final Post post;
  final ind;

  const PostContainerDiary({
    Key? key,
    required this.post,
    this.ind,
  }) : super(key: key);
      ...
      children: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                post.user.name == null ? 'Anonymous' : post.user.name,
...
class _PostStatsState extends State<_PostStats> {
  ...
  fecthData() async {
    ...
    print(res.body);
    print(Get.find<PostController1>().diary_posts[widget.ind].likes);
    print(Get.find<PostController1>().diary_posts[widget.ind].isAlreadyLiked);

    Get.find<PostController1>().updatePostsLikedDiray(widget.ind);
          ...
          children: [
            Row(
              children: [
                ...
                Expanded(
                  ...
                  child: Text(
                    '${_.diary_posts[widget.ind].likes}',
                    style: TextStyle(
                      color: Colors.grey[600],
                    ),
                  ),
            ...
            Row(
              children: [
                _PostButton(
                    icon: Icon(
                      _.diary_posts[widget.ind].isAlreadyLiked
                          ? MdiIcons.thumbUp
