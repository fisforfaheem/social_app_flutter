...
class PostContainerClassWall extends StatelessWidget {
  final Post post;
  final ind;

  const PostContainerClassWall({
    Key? key,
    required this.post,
    this.ind,
  }) : super(key: key);
...
class _PostStatsState extends State<_PostStats> {
  ...
  fecthData() async {
    ...
    print(res.body);
    print(Get.find<PostController1>().class_posts[widget.ind].likes);
    print(Get.find<PostController1>().class_posts[widget.ind].isAlreadyLiked);

    Get.find<PostController1>().updatePostsLikedClasswall(widget.ind);
          ...
          children: [
            Row(
              children: [
                ...
                Expanded(
                  ...
                  child: Text(
                    '${_.class_posts[widget.ind].likes}',
                    style: TextStyle(
                      color: Colors.grey[600],
                    ),
                  ),
            ...
            Row(
              children: [
                _PostButton(
                    icon: Icon(
                      _.class_posts[widget.ind].isAlreadyLiked
                          ? MdiIcons.thumbUp
