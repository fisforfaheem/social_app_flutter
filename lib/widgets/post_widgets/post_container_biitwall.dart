...
class PostContainerBiitWall extends StatelessWidget {
  final Post post;
  final ind;
...
class _PostStatsState extends State<_PostStats> {
  ...
  fecthData() async {
    ...
    print(res.body);
    print(Get.find<PostController1>().biitwall_posts[widget.ind].likes);
    print(
        Get.find<PostController1>().biitwall_posts[widget.ind].isAlreadyLiked);

    Get.find<PostController1>().updatePostsLikedBiitwall(widget.ind);
          ...
          children: [
            Row(
              children: [
                ...
                Expanded(
                  ...
                  child: Text(
                    '${_.biitwall_posts[widget.ind].likes}',
                    style: TextStyle(
                      color: Colors.grey[600],
                    ),
                  ),
            ...
            Row(
              children: [
                _PostButton(
                    icon: Icon(
                      _.biitwall_posts[widget.ind].isAlreadyLiked
                          ? MdiIcons.thumbUp
